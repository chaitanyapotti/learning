...
namespace LambdasAndDelegates
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Func<int, string, bool> myFunc1 = (x, y) => int.TryParse(y, out x);

            Func<int, string, bool> myFunc2;

            myFunc2 = (x, y) => int.TryParse(y, out x);

            var boolena = myFunc2(1, "2");
