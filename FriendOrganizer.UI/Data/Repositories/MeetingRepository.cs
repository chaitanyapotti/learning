...
namespace FriendOrganizer.UI.Data.Repositories
{
    public class MeetingRepository : GenericRepository<Meeting, FriendOrganizerDbContext>, IMeetingRepository
    {
        ...
        {
            return await Context.Meetings.Include(m => m.Friends).SingleAsync(x => x.Id == id);
        }
        ...
        public  async Task ReloadFriendAsync(int argsId)
        {
            var dbEntityEntry = Context.ChangeTracker.Entries<Friend>().SingleOrDefault(x => x.Entity.Id == argsId);
